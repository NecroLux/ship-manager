...
- [ ] **Crew Tab reorganization** — Split compliance, add voyage/host counts, centre status
- [ ] **Data health** — Centralize all data sources so Overview doesn't pull directly from external sheets
- [ ] **Actions Tab upgrades** — Sailing → Squad Leaders, + staff comments parsing
...
- [x] **Ship Composition icons** — Fix command member round icon display (Red/Pink/Purple)
- [ ] **Snapshot insights** — Month-to-month trend analysis and deltas
- [ ] **Overview insight cards** — Awards this month, Key wins, MOTD, engagement highlights
- [ ] **Spice paywall easter egg** — 4 Ancient Coins unlock (fun one!)
